...
class SamplingDistribution(checkpointers.Checkpointable, Protocol):
    ...
    def update(self, keys: "npt.NDArray[ReplayItemID] | ReplayItemID", **kwargs: Any) -> None: ...
...
class UniformSamplingDistribution(SamplingDistribution):
    ...
    @typing.overload
    def update(self, keys: npt.NDArray[ReplayItemID], *args: Any, **kwargs: Any) -> None: ...
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        logging.log_first_n(logging.WARN, "`UniformDistribution.update` is a no-op, ignoring...", 1)
