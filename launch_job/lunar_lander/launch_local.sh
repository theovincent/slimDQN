...
do
    ...
    command="lunar_lander_dqn -e $EXPERIMENT_NAME -hl $HIDDEN_LAYER -s $seed -gamma $GAMMA"
    ...
    eval $command &> experiments/LunarLander/logs/$EXPERIMENT_NAME/DQN/seed=$seed.out &
done