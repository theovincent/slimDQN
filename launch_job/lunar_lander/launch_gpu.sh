...
submission_train_dqn="sbatch -J L_train_dqn --array=$FIRST_SEED-$LAST_SEED --cpus-per-task=3 --mem-per-cpu=750Mc --time=3:30:00 -p amd,amd2"
...
submission_train_dqn=$(submission_train_dqn)